...
/*
Entre aspas está descirto um pedido feito por um cliente para um restaurante. 
Preciso que você gere um array de objetos JSON que indique a quantidade de cada item, ou seja, as chaves do json são "quantidade" e "item". 
Os itens iguais devem estar com suas quantidades somadas e você deve identificar itens iguais mesmo que o usuário tenha digitado um nome diferente como por exemplo coca-cola ou coca. 
Por favor, só me reotrne o JSON, não escreva mais nada.
 "Quero 2 cheese burguer, 3 lanches especiais, 1 coca-cola e 3 águas. Ah, e tira 1 chese buguer, só quero 1 mesmo"'
*/